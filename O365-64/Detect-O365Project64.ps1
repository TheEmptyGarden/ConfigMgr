# Name:         Detect-O365Project64
# Description:  Detects O365Project64
...
try
{
  ...
  Function SetGlobalEnvVariables
  {
    ...
    $Script:LoggingPath = 'c:\Windows\Temp\Detect-O365Project64.log'
  ...
  Function DetectO365Project64
  {
    # Function Started
    LogTraceMessage "*** Function DetectO365Project64 Started ***"
    Write-Verbose "*** Function DetectO365Project64 Started ***"
    ...
    $Script:AppDetect = if ($ClickToRun = $True -and ($ClickToRunVersionToRerport -ge '16.0.10325.20082' -or $ClickToRunClientVersionToReport -ge '16.0.10325.20082') -and $ClickToRunPlatform -eq "x64" -and $ClickToRunProductReleaseIDs -like "*Project*" -and $ClickToRunProject -eq $True)
    ...
    LogTraceMessage "DetectO365Project64 is $Script:AppDetect"
    Write-Verbose "DetectO365Project64 is $Script:AppDetect"

    LogTraceMessage "*** FunctionDetectO365Project64 Finished ***"
    Write-Verbose "*** Function DetectO365Project64 Finished ***"
   }
