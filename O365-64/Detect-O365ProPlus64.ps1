# Name:         Detect-O365ProPlus64
# Description:  Detects O365ProPlus64
...
try
{
  ...
  Function SetGlobalEnvVariables
  {
    ...
    $Script:LoggingPath = 'c:\Windows\Temp\Detect-O365ProPlus64.log'
  ...
  Function DetectO365ProPlus64
  {
    # Function Started
    LogTraceMessage "*** Function DetectO365ProPlus64 Started ***"
    Write-Verbose "*** Function DetectO365ProPlus64 Started ***"
...
If ($OSArchitecture -eq '64-bit')
    ...
    $Script:AppDetect = if ($ClickToRun = $True -and ($ClickToRunVersionToRerport -ge '16.0.10325.20082' -or $ClickToRunClientVersionToReport -ge '16.0.10325.20082') -and $ClickToRunPlatform -eq "x64" -and $ClickToRunProductReleaseIDs -like "*O365ProPlusRetail*" -and $ClickToRunMSAccess -eq $True -and $ClickToRunOutlook -eq $True -and $ClickToRunMSPub -eq $True -and $ClickToRunExcel -eq $True -and $ClickToRunOneNote -eq $True -and $ClickToRunPowerPoint -eq $True)
    ...
    LogTraceMessage "DetectO365ProPlus64 is $Script:AppDetect"
    Write-Verbose "DetectO365ProPlus64 is $Script:AppDetect"

    LogTraceMessage "*** FunctionDetectO365ProPlus64 Finished ***"
    Write-Verbose "*** Function DetectO365ProPlus64 Finished ***"
   }
