# Name:         Uninstall-O365Skype64
# Description:  Uninstalls O365Skype64
...
try
{
  ...
  Function SetGlobalEnvVariables
  {
    ...
    $Script:LoggingPath = 'c:\Windows\Temp\Uninstall-O365Skype64.log'
  ...
  Function UninstallO365Skype64
  {
    # Function Started
    LogTraceMessage "*** Function UnInstallO365Skype64 Started ***"
    Write-Verbose "*** Function UnInstallO365Skype64 Started ***"

    $Script:proc = (Start-Process -FilePath "setup.exe" -ArgumentList "/configure Skype365Uninstall64Configuration.xml" -PassThru)

    
    LogTraceMessage "UnInstallO365Skype64 ID =  $($Script:proc.ID)"
    Write-Verbose "UnInstallO365Skype64 ID =  $($Script:proc.ID)" 
