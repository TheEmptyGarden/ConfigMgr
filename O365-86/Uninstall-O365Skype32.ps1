# Name:         Uninstall-O365Skype32
# Description:  Uninstalls O365Skype32
...
try
{
  ...
  Function SetGlobalEnvVariables
  {
    ...
    $Script:LoggingPath = 'c:\Windows\Temp\Uninstall-O365Skype32.log'
  ...
  Function UninstallO365Skype32
  {
    # Function Started
    LogTraceMessage "*** Function UnInstallO365Skype32 Started ***"
    Write-Verbose "*** Function UnInstallO365Skype32 Started ***"

    $Script:proc = (Start-Process -FilePath "setup.exe" -ArgumentList "/configure Skype365Uninstall64Configuration.xml" -PassThru)

    
    LogTraceMessage "UnInstallO365Skype32 ID =  $($Script:proc.ID)"
    Write-Verbose "UnInstallO365Skype32 ID =  $($Script:proc.ID)" 
