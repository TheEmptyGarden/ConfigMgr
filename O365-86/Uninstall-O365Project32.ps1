# Name:         Uninstall-O365Project32
# Description:  Installs O365Project32
...
try
{
  Function Main
  {
    ...
    #Install O365Project32
    UninstallO365Project32
  ...
  Function SetGlobalEnvVariables
  {
    ...
    $Script:LoggingPath = 'c:\Windows\Temp\Install-O365Project32.log'
  ...
  Function UninstallO365Project32
  {
    # Function Started
    LogTraceMessage "*** Function UnInstallO365Project32 Started ***"
    Write-Verbose "*** Function UnInstallO365Project32 Started ***"

    $Script:proc = (Start-Process -FilePath "setup.exe" -ArgumentList "/configure Project365Uninstall32Configuration.xml" -PassThru)

    
    LogTraceMessage "UnInstallO365Project32 ID =  $($Script:proc.ID)"
    Write-Verbose "UnInstallO365Project32 ID =  $($Script:proc.ID)" 
