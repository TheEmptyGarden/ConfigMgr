# Name:         Detect-O365Visio32
# Description:  Detects O365Visio32
...
try
{
  ...
  Function SetGlobalEnvVariables
  {
    ...
    $Script:LoggingPath = 'c:\Windows\Temp\Detect-O365Visio32.log'
  ...
  Function DetectO365Visio32
  {
    # Function Started
    LogTraceMessage "*** Function DetectO365Visio32 Started ***"
    Write-Verbose "*** Function DetectO365Visio32 Started ***"
    ...
    If ($OSArchitecture -eq '64-bit')
        {
        $ClickToRunVisio = Test-Path "${env:ProgramFiles(x86)}\Microsoft Office\root\Office16\Visio.exe"
    ...
    $Script:AppDetect = if ($ClickToRun = $True -and ($ClickToRunVersionToRerport -ge '16.0.10325.20082' -or $ClickToRunClientVersionToReport -ge '16.0.10325.20082') -and $ClickToRunPlatform -eq "x86" -and $ClickToRunProductReleaseIDs -like "*Visio*" -and $ClickToRunVisio -eq $True)
    ...
    LogTraceMessage "DetectO365Visio32 is $Script:AppDetect"
    Write-Verbose "DetectO365Visio32 is $Script:AppDetect"

    LogTraceMessage "*** FunctionDetectO365Visio32 Finished ***"
    Write-Verbose "*** Function DetectO365Visio32 Finished ***"
   }
