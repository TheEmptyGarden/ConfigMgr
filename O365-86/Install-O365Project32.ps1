    ...
    If (((Get-ItemProperty -path 'HKLM:\Software\Microsoft\Office\ClickToRun\Configuration').Platform) -eq "x64")
      {
        ...
        $Script:proc = (Start-Process -FilePath "setup.exe" -ArgumentList "/configure Project365UninstallALL32Configuration.xml" -PassThru)
